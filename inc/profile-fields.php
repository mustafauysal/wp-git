...
function wp_github_extra_profile_info( $user ) {
	...
	<table class="form-table">
		<tr>
			<th><label for="wp_github_bio"><?php _e( 'Bio', 'wp-git' ); ?></label></th>
		...
		<tr>
			<th><label for="wp_github_company"><?php _e( 'Company', 'wp-git' ); ?></label></th>
		...
		<tr>
			<th><label for="wp_github_location"><?php _e( 'Location', 'wp-git' ); ?></label></th>
		...
		<tr>
			<th><label for="wp_github_location"><?php _e( 'Email', 'wp-git' ); ?></label></th>
